...
export const PRODUCTS: Product[] = [
  ...
  // Mochilas e Estojos
  { id: '101', name: 'Mochila de Costas Mario', price: 210.00, imageUrl: 'https://i.imgur.com/Nrx38ax.jpeg', category: 'MOCHILAS_ESTOJOS' },
  { id: '102', name: 'Lancheira Térmica Mario P', price: 135.00, imageUrl: 'https://i.imgur.com/spf791u.jpeg', category: 'MOCHILAS_ESTOJOS' },
  { id: '103', name: 'Lancheira Térmica Mario G', price: 135.00, imageUrl: 'https://i.imgur.com/HWC4C7u.jpeg', category: 'MOCHILAS_ESTOJOS' },
  { id: '104', name: 'Lancheira Patrulha Canina Sky e Everest', price: 135.00, imageUrl: 'https://i.imgur.com/AYv7JOE.jpeg', category: 'MOCHILAS_ESTOJOS' },
  { id: '105', name: 'Mochila Patrulha Canina Chase e Marshall', price: 269.00, imageUrl: 'https://i.imgur.com/Q4OpNNX.jpeg', category: 'MOCHILAS_ESTOJOS' },
  { id: '106', name: 'Estojo Duplo Patrulha Canina Chase e Marshall', price: 69.00, imageUrl: 'https://i.imgur.com/nRkUspv.jpeg', category: 'MOCHILAS_ESTOJOS' },
  { id: '107', name: 'Lancheira Térmica Sonic', price: 165.00, imageUrl: 'https://i.imgur.com/MjGIW58.jpeg', category: 'MOCHILAS_ESTOJOS' },
];
